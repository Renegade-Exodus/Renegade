...
1/30/26 - I added a complete light bar setup for the message reader.  I also added a archive lightbar viewer that can view ANSI and TEXT inside an archive.
