...
2/06/26 - I added a complete light bar setup for the Message Reader and File listing.  I also added a archive lightbar viewer that can view ANSI and TEXT inside an archive.
